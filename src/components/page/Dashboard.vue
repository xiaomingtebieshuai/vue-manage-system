    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table
                ...
                <el-table-column prop="planeNoticeEntity.announceId" label="通告编号" width="120">
                </el-table-column>
                <el-table-column prop="planeNoticeEntity.airportId" label="机场编码" width="120">
                </el-table-column>
                ...
                <el-table-column prop="planeNoticeEntity.isClose" label="关闭状态" width="100">
                </el-table-column>
